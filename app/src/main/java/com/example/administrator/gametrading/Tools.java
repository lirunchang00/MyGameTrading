...
public class Tools {
    ...
    public static String forumEssenceUrl = baseUrl+"getEssencePost";

    public static String sendPostUrl = baseUrl+"sendPost";

    public static String repeatPostUrl = baseUrl+"repeatPost";

    public static String showPostUrl = baseUrl+"showRepeatPost";
